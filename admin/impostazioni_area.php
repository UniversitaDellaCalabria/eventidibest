...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold text-dark m-0"><i class="fa fa-paint-brush text-primary me-2"></i> Impostazioni Estetiche e Funzionali Area</h4>
</div>

<div class="card shadow-sm border-0 p-4 mb-4">
    <h5 class="fw-bold text-primary border-bottom pb-2 mb-3">🎨 Configurazione Grafica, Layout e Contenuti: <?php echo htmlspecialchars($page_cfg['titolo'] ?? ''); ?></h5>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="p-3 bg-white rounded border border-danger mb-4 shadow-sm">
            <h6 class="fw-bold text-danger border-bottom pb-2 mb-3">📌 Personalizzazione Sidebar Laterale (Fissa a Sinistra)</h6>
            <div class="row g-3">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4"><label class="form-label small fw-bold text-danger">Upload Banner Custom</label><input type="file" name="hero_banner_file" class="form-control" accept="image/*"></div>
        ...
        <div class="mb-4 p-3 border rounded bg-light border-danger">
        ...
        <!-- BLOCCO CONFIGURAZIONE ATTESTATI PER L'AREA -->
        <div class="p-3 bg-light border border-secondary rounded shadow-sm mb-4">
            <h6 class="fw-bold text-secondary border-bottom border-secondary pb-2 mb-3"><i class="fa fa-signature me-1"></i> Configurazione Firmatario e Logo Attestati per quest'Area</h6>
            <div class="row g-3">
                <div class="col-md-12">
        ...
        <button type="submit" name="save_pagina_config" onclick="tinymce.triggerSave();" class="btn btn-primary fw-bold px-4 py-3 w-100"><i class="fa fa-save me-1"></i> Salva Impostazioni Pagina</button>
    </form>
</div>
